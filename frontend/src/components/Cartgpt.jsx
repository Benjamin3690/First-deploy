...
const CartDetail = () => {
    const [cartItems, setCartItems] = useState([
        { id: 1, name: 'Product One', price: 29.99, quantity: 1, image: 'https://via.placeholder.com/100' },
        { id: 2, name: 'Product Two', price: 19.99, quantity: 1, image: 'https://via.placeholder.com/100' },
    ]);
